      ...
      <div className="w-full max-w-2xl space-y-8">
        <div className="text-center space-y-4">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-foreground text-balance">
            Turn notes into <span className="bg-green-500 px-3 py-1 rounded-lg">quizzes</span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-md mx-auto">
            Paste your study notes and we&apos;ll generate an interactive quiz to test your
            knowledge.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            ...
            {!isValid && notes.length > 0 && <span>Need at least 20 characters</span>}
          </div>
